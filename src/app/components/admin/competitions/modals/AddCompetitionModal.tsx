...
const AddCompetitionModal = ({
  ...
  const [errors, setErrors] = useState<Partial<NewCompetitionData>>({});
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<NewCompetitionData> = {};
    ...
    <dialog className="modal modal-open">
      <div className="modal-box max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="alert alert-info mt-6">
          ...
          <div>
            <h3 className="font-bold">Competition Guidelines:</h3>
            <div className="text-sm mt-1">
              • Provide accurate event information and valid URLs
              <br />
              • Select appropriate type, rivalry format, and level
              <br />
              • Both past and future event dates are accepted
              <br />
              • Reference links help admins verify competition authenticity
              <br />• Competitions will be reviewed before going live
            </div>
          </div>
        </div>
