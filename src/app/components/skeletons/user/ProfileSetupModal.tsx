...
const ProfileSetupModal: React.FC<ProfileSetupModalProps> = ({
  ...
  const handleFileUpload = async (file: File, type: 'profile' | 'cover') => {
    ...
    const setLoading = type === 'profile' ? setProfilePictureLoading : setCoverImageLoading;
    setLoading(true);
  ...
  const validateStep = (step: number): boolean => {
    ...
    switch (step) {
      case 1:
        if (!formData.cosplayerType || !['COMPETITIVE', 'HOBBY', 'PROFESSIONAL'].includes(formData.cosplayerType)) {
      ...
      <div className="bg-base-100 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-base-200">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-primary">Welcome to COSBAII!</h2>
              <p className="text-base-content/70">Let's set up your cosplay profile</p>
            </div>
            <button 
              onClick={handleSkip}
        ...
        <div className="p-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-2">What type of cosplayer are you?</h3>
                <p className="text-base-content/70">This helps us tailor your experience</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div 
                  ...
                  onClick={() => setFormData({...formData, cosplayerType: 'COMPETITIVE'})}
                >
                ...
                <div 
                  ...
                  onClick={() => setFormData({...formData, cosplayerType: 'HOBBY'})}
                >
                  <div className="card-body text-center">
                    <div className="text-4xl mb-3">🎨</div>
                ...
                <div 
                  ...
                  onClick={() => setFormData({...formData, cosplayerType: 'PROFESSIONAL'})}
                >
                  <div className="card-body text-center">
                    <div className="text-4xl mb-3">💼</div>
              ...
              {errors.cosplayerType && (
                <p className="text-error text-sm text-center">{errors.cosplayerType}</p>
              )}
            </div>
          )}
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-2">Tell us about your skills</h3>
                <p className="text-base-content/70">Help us understand your expertise</p>
              </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-base-content/70">Add your display name and bio</p>
              </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-2">Add profile pictures</h3>
                <p className="text-base-content/70">Upload your profile and cover images</p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                  <p className="text-sm text-base-content/70">Profile Picture</p>
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                <div className="h-32 bg-base-200 rounded-lg overflow-hidden relative group cursor-pointer"
              ...
              <div className="alert alert-info">
                ...
                <div>
                  ...
                  <div className="text-xs mt-1">
                    ...
                    • Recommended: Square images for profile, 16:9 for cover
                  </div>
                </div>
              </div>
              ...
              <div className="bg-base-200 p-4 rounded-lg">
                ...
                <ul className="space-y-1 text-sm">
                  <li>• Type: {
                    formData.cosplayerType === 'COMPETITIVE' ? '🏆 Competitive' : 
                    formData.cosplayerType === 'HOBBY' ? '🎨 Hobby' :
                    formData.cosplayerType === 'PROFESSIONAL' ? '💼 Professional' :
                    'Not selected'
                  }</li>
                  <li>• Experience: {formData.yearsOfExperience ? `${formData.yearsOfExperience} years` : 'Not specified'}</li>
                  <li>• Specialization: {formData.specialization || 'Not specified'}</li>
                  <li>• Skill Level: {formData.skillLevel.charAt(0).toUpperCase() + formData.skillLevel.slice(1)}</li>
