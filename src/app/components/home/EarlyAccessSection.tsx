...
export default function EarlyAccessSection() {
  return (
    ...
    <section className="max-w-[1440px] py-20 mx-auto flex items-center justify-center">
        <div className="w-full flex flex-col sm:flex-row bg-pale px-6 pb-10 rounded-xl">
            ...
            <div className="w-[100%] sm:w-[50%] flex flex-col gap-4 justify-center p-2 sm:p-10">
