 ...
 return (
    <section className="w-full mx-auto flex flex-col-reverse sm:flex-row items-center justify-between py-10 sm:py-20  gap-5 sm:gap-10">
        <div className="w-full lg:w-[50%] sm:w-[40%] sm:pl-[10%] justify-content-center p-4">
            <h5 className="text-xl color-cosbaii-primary font-bold">FOR COSPLAYERS IDENTITY</h5>
...
career spotlight</h1>
            ...
            <a href="#" className="w-full sm:w-auto btn btn-primary btn-lg button-gradient text-white mt-8 sm:mt-16 border-none px-12">GET EARLY ACCESS</a>
        </div>
