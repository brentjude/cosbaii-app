    ...
    <main className="w-full bg-primary/5 p-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-200">
        ...
        <div className="flex flex-row max-md:flex-col gap-[20%] max-md:gap-4 justify-between mt-[-50px] max-md:mt-[-20px] z-10 relative">
            <div className="flex flex-row gap-1 basis-1/3 bg-white rounded-r-full rounded-tl-full rounded-bl-full ml-[-30px] max-md:ml-[0px] shadow-lg" >
                ...
                <div className="flex flex-col items-left pl-4 pr-8 ">
                    <h1 className="text-3xl max-md:text-2xl font-bold text-gray-900 mt-4">
                        {profile?.displayName || session?.user?.name || 'No Display Name'}
                    </h1>
                    <p className="text-sm text-gray-400">@{session?.user?.username || 'username'}</p>
            ...
            <div className="flex flex-row max-md:justify-center gap-2 basis-2/3">
                ...
                <div className="card basis-1/3 flex flex-col justify-center items-center bg-white p-4 shadow-lg rounded-lg">
                    ...
                    <span className="text-sm text-gray-500">Competition Joined</span>
                </div>
            </div>
        </div>
            ...
            <div className="flex flex-row justify-between items-center">
                <div>
                    <ul className="flex flex-row gap-6 text-sm text-gray-600 font-bold">
                        <li><a href="#" className='hover:text-primary'>INFO</a></li>
                        <li><a href="#" className='hover:text-primary'>FEATURED</a></li>
                        <li><a href="#" className='hover:text-primary'>CREDENTIALS</a></li>
      ...
      <div className="flex flex-row items-start gap-4 mt-4">
        ...
        <div className="basis-1/3 bg-white rounded-2xl p-6 border border-gray-200">
            <div>
                 <h2 className="text-xl font-bold">Hi, I'm {profile?.displayName || session?.user?.name || 'No Display Name'}</h2>
            ...
            {profile?.yearsOfExperience !== null && profile?.yearsOfExperience !== undefined && (
                ...
                {profile.yearsOfExperience === 0 ? 'Just starting' : 
        ...
        <div className="basis-2/3 flex flex-col gap-4">
            ...
            <div className='relative h-100 bg-white rounded-2xl border border-gray-200'>
                <div className="absolute l-4 flex justify-betweem items-center w-full">
                    <h2 className="absolute top-4 left-4 text-xl font-bold mb-4 text-white">Featured</h2>

                    {/* Edit Featured Button */}
                    <button className="absolute btn btn-primary btn-sm py-6 rounded-full top-2 right-4 tooltip tooltip-white"  data-tip="Edit Featured Cosplay">
                ...
                <div className="flex flex-row">
                    {/* First Card Feature */}
                    <div className="basis-1/3 flex flex-row items-end h-100 bg-gray-100 rounded-l-lg" style={{ backgroundImage: 'url(/images/sample-featured.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>

                        {/* Competition Placeholder */}
                        <div className="flex flex-col w-60 mx-auto py-2 px-6 mb-4 bg-white rounded-2xl shadow-md">
                            <div className="flex flex-row gap-2">
                              
                                <h3 className='text-xs font-bold'> 2018 | Otakufest Dou Cosplay Competition</h3>
                            ...
                            <div className="flex flex-row justify-between items-center p-2">
                                <span className="text-[10px] text-gray-500">Cosplay Name</span>
                                <span className="text-[10px] font-bold ml-2">Mikasa Ackerman</span>
                            </div>
                        </div>
                    </div>
                    {/* Second Card Feature */}
